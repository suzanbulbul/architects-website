            ...
            u &&
              E.jsxs("div", {
                ...
                children: [
                  E.jsxs("header", {
                    className:
                      "flex justify-between items-center p-4 rounded-lg shrink-0",
                    style: {
